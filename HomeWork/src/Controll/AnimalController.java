...
public class AnimalController {
    ...
    private void showAnimals(ANIMALS animal){
        ...
        switch (animal){
            case CAT -> animals = Collections.singletonList(animalList.getCats());
            case DOG -> animals = Collections.singletonList(animalList.getDogs());
            case HAMSTER -> animals = Collections.singletonList(animalList.getHamsters());
        }
